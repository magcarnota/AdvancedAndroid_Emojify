...
class Emojifier {
    ...
    private static final float SMILING_THRESHOLD = .15f;
    private static final float EYE_OPENED_THRESHOLD = .5f;
    ...
    private static void whichEmoji(Face face){
        ...
        boolean leftEyeOpened = face.getIsLeftEyeOpenProbability() > EYE_OPENED_THRESHOLD;
        boolean rightEyeOpened = face.getIsRightEyeOpenProbability() > EYE_OPENED_THRESHOLD;
